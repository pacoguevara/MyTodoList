...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didRegisterUserNotificationSettings notifficationSettings: UIUserNotificationSettings){
        print("Notificaciones aceptadas \(notifficationSettings.types)")
    }
